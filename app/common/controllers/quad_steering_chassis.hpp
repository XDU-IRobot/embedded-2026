...
public:
    ...
    void Update(float lf_steer_position, float lf_steer_speed, float rf_steer_position, float rf_steer_speed,
                ...
                float lf_wheel_speed, float rf_wheel_speed, float lb_wheel_speed, float rb_wheel_speed,
                float dt = 1.f) {
        // 更新当前状态
        ...
        const auto fk_result =
                kinematics_.Forward(target_.vx, target_.vy, target_.w, state_.lf_steer_position,
                                    state_.rf_steer_position,
