...
void GlobalWarehouse::GimbalPIDInit() {
  // 初始化PID
  // 上部 Yaw PID 参数
  gimbal_controller.pid().up_yaw_position.SetKp(18.0f).SetKi(0.0f).SetKd(0.0f).SetMaxOut(25000.0f).SetMaxIout(0.0f);
  gimbal_controller.pid().up_yaw_speed.SetKp(8500.0f).SetKi(0.0f).SetKd(0.0f).SetMaxOut(25000.0f).SetMaxIout(0.0f);
  // 下部 Yaw PID 参数
  ...
  // pitch PID 参数
  gimbal_controller.pid().pitch_position.SetKp(75.0f).SetKi(0.0f).SetKd(0.0f).SetMaxOut(30.0f).SetMaxIout(0.0f);
...
void GlobalWarehouse::SubLoop250Hz() {
  ...
  globals->pitch_motor->SetMitCommand(0, 0, -gimbal->pitch_torque_, 0, 3.3f);
}
