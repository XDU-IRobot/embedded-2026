...
- 弧度制
- yaw：euler⬆️，电机方向左⬅️
- pitch：euler⬆️，电机方向下⬇️
## 零飘
- 陀螺仪gyro_z值趋于0
  - 给gyro_z加滤波
  - 采样取平均，减去该值
> 认为滤波后小于一定范围的陀螺仪z轴值为误差，实时统计该误差并补偿。并加入与pitch角正相关的一个值去补偿陀螺仪误差（我不明白为什么实时统计的误差不足以补偿，但确实加了这个值就是能解决，可能是我设的范围太小了？）
# pitch轴、随动PID
- 双环PID
- 系统辨识
- 经验法
