...
class ChassisCommunicator final : public CanDevice {
 public:
  ...
  u16 heat_real() const { return heat_real_; }
  u16 heat_limit() const { return heat_limit_; }
  u16 cooling_speed() const { return cooling_speed_; }
  f32 ammo_speed() const { return ammo_speed_; }
  u8 robot_id() const { return robot_id_; }
  u8 gimbal_power_state() const { return gimbal_power_state_; }
  u8 chassis_power_state() const { return chassis_power_state_; }
  u8 ammo_power_state() const { return ammo_power_state_; }
