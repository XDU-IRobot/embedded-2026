    ...
    for (int retry = 0; retry < 2; retry++) {
        ...
        if (res == FR_OK) {
            ...
            int len = snprintf(text, sizeof(text),
                     "%d %d %d %d %d %d %d %d",
                     (int)(Pitch[0] * 1000.0f), (int)(Pitch[1] * 1000.0f), (int)(Pitch[2] * 1000.0f), (int)(Pitch[3] * 1000.0f),
                     (int)(Yaw[0] * 1000.0f),   (int)(Yaw[1] * 1000.0f),   (int)(Yaw[2] * 1000.0f),   (int)(Yaw[3] * 1000.0f));
...
void SD_Card_info() {
  ...
  if (HAL_SD_GetCardInfo(&hsd, &card_info) == HAL_OK) {
    snprintf(uart_buf, sizeof(uart_buf),
             ...
             (unsigned long)card_info.Class,
             (unsigned long)card_info.RelCardAdd,
