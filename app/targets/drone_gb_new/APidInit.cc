...
void Gimbal::GimbalPIDInit() {
  gimbal_controller.pid().yaw_position.SetKp(350.0f).SetKi(0.0f).SetKd(3000.0f).SetMaxOut(10000.0f).SetMaxIout(
      1000.0f).SetDiffLpfAlpha(0.5);  // TODO yaw初版函数 160 0.0 0.01
