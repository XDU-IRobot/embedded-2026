...
class Gimbal2DofDynamics {
 ...
 private:
  ...
  const Eigen::Matrix<float, 9, 1> THETA{
      -0.012560f,  // theta_1 (I1zz_com) 可根据实机效果清零
      -0.018796f,  // theta_2 (I2xx_com) 可根据实机效果清零
      0.026591f,   // theta_3 (I2yy_com)
      -0.021296f,  // theta_4 (m2*l2x 水平偏心)
      0.050746f,   // theta_5 (m2*l2z 垂直偏心)
      0.027809f,   // theta_6 (fv1) - Yaw 粘性摩擦
      0.151604f,   // theta_7 (fc1) - Yaw 库仑摩擦
      0.092970f,   // theta_8 (fv2) - Pitch 粘性摩擦
      0.038418f    // theta_9 (fc2) - Pitch 库仑摩擦
  };
};