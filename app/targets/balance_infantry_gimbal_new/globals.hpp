...
//  rm::device::HipnucImu imu{imu_serial};
  ...
  rm::device::DmMotor<rm::device::DmMotorControlMode::kMit> yaw_motor{can1, {0x10, 0x09, M_PI, 30.0f, 10.0f, {0.0f, 500.0f}, {0.0f, 5.0f}}}; ///< 云台 Yaw 上电机
  rm::device::DmMotor<rm::device::DmMotorControlMode::kMit> pitch_motor{can2, {0x05, 0x04, M_PI, 30.0f, 10.0f, {0.0f, 500.0f}, {0.0f, 5.0f}}}; ///< 云台 Pitch 电机
