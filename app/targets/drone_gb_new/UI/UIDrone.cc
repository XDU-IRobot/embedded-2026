...
void UIDroneHero_add() {
  UIFigure7 UIGroup1;
  UIGroup1.figure1.fillFloat("yaw", UIFigure::Operation::Add, 0,
                             UIFigure::Color::Yellow, 5, 1460, 470, 20,
                             gimbal->referee_user.data().hero_2_drone.hero_yaw_angle * 1000);
  UIGroup1.figure2.fillFloat("pit", UIFigure::Operation::Add, 0,
                             UIFigure::Color::Black, 5, 1620, 470, 20,
                             gimbal->referee_user.data().hero_2_drone.hero_pitch_angle * 1000);
  UIGroup1.figure3.fillIntegrate("adj", UIFigure::Operation::Add, 0,
                                 UIFigure::Color::Green, 5, 1650, 580, 22,
                                 gimbal->referee_user.data().hero_2_drone.hero_ammo_adjust);
  UIGroup1.figure4.fillFloat("isp", UIFigure::Operation::Add, 0,
                             UIFigure::Color::Cyan, 5, 1460, 580, 22,
                             gimbal->referee_user.data().hero_2_drone.hero_initial_speed * 1000);
  UIGroup1.figure5.fillFloat("cya", UIFigure::Operation::Add, 0,
                             UIFigure::Color::RedBlue, 5, 1460, 520, 24,
                             cmd_yaw * 1000);
  UIGroup1.figure6.fillFloat("dyw", UIFigure::Operation::Add, 0,
                           UIFigure::Color::Yellow, 5, 1460, 420, 20,
                           gimbal->yaw_ * 1000);
  UIGroup1.figure7.fillFloat("dpt", UIFigure::Operation::Add, 0,
                             UIFigure::Color::Black, 5, 1620, 420, 20,
                             gimbal->pitch_ * 1000);

  const auto dataLen = Referee0x301Prepare(dataBox, 0, UIGroup1, robotID,
                                           robotID + 256);
...
void UIDroneHero_edit() {
  UIFigure7 UIGroup1;
  UIGroup1.figure1.fillFloat("yaw", UIFigure::Operation::Edit, 0,
                             UIFigure::Color::Yellow, 5, 1460, 470, 20,
                             gimbal->referee_user.data().hero_2_drone.hero_yaw_angle * 180 / 3.1415 * 1000);
  UIGroup1.figure2.fillFloat("pit", UIFigure::Operation::Edit, 0,
                             UIFigure::Color::Magenta, 5, 1620, 470, 20,
                             gimbal->referee_user.data().hero_2_drone.hero_pitch_angle * 1000);
  UIGroup1.figure3.fillIntegrate("adj", UIFigure::Operation::Edit, 0,
                                 UIFigure::Color::Green, 5, 1650, 580, 22,
                                 gimbal->referee_user.data().hero_2_drone.hero_ammo_adjust);
  UIGroup1.figure4.fillFloat("isp", UIFigure::Operation::Edit, 0,
                             UIFigure::Color::Cyan, 5, 1460, 580, 22,
                             gimbal->referee_user.data().hero_2_drone.hero_initial_speed * 1000);
  UIGroup1.figure5.fillFloat("cya", UIFigure::Operation::Edit, 0,
                             UIFigure::Color::RedBlue, 5, 1460, 520, 24,
                             cmd_yaw * 180 / 3.1415 * 1000);
  UIGroup1.figure6.fillFloat("dyw", UIFigure::Operation::Edit, 0,
                         UIFigure::Color::Yellow, 5, 1460, 420, 20,
                         gimbal->yaw_ * 1000);
  UIGroup1.figure7.fillFloat("dpt", UIFigure::Operation::Edit, 0,
                             UIFigure::Color::Black, 5, 1620, 420, 20,
                             gimbal->pitch_ * 1000);
  const auto dataLen = Referee0x301Prepare(dataBox, 0, UIGroup1, robotID,
                                           robotID + 256);
...
void D2H_func() {
  ...
  if (!state_) {
    ...
    if (gimbal->Rcchoose() == 2) {
      if (gimbal->vt03->data().keyboard_key & static_cast<int16_t>(rm::device::VT03::KeyboardKey::kA)) cmd_yaw += 0.000125f;
      if (gimbal->vt03->data().keyboard_key & static_cast<int16_t>(rm::device::VT03::KeyboardKey::kD)) cmd_yaw -= 0.000125f;
    } else if(gimbal->Rcchoose() == 1) {
  ...
  const auto size = Referee0x301Prepare(dataBox, 0, d2h,
                                                    robotID,
                                                    robotID - 5);
